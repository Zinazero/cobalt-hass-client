...
var jsc = {
	...
	pub : function (targetElement, opts) {
		...
		this.previewPosition = ''; // 'left' | 'right' - position of the color preview in previewElement
		...
		this.height = 300; // height of color palette (in px)
		this.mode = 'HS'; // 'HSV' | 'HVS' | 'HS' | 'HV' - layout of the color picker controls
		this.alphaChannel = false; // 'auto' | true | false - if alpha channel is enabled, the alpha slider will be visible. If 'auto', it will be determined according to color format
		...
		this.closeText = 'Okay';
		this.buttonColor = '#1274ff'; // CSS color
		this.buttonHeight = 36; // px
		this.padding = 12; // px
		this.backgroundColor = '#f5f8fc'; // CSS color
